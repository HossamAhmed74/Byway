...
export default function LandingWithoutLogin() {
  return (
    <>
      <Header />
      <div>
        <div className="grid grid-cols-12 min-h-screen">
          ...
          <div className="col-span-5 flex flex-col justify-center items-center px-10">
            ...
            <Link
              to="./signUp"
              type="button"
              className="inline-block text-center w-60 h-10 relative right-[7rem] rounded bg-blue-600 px-6 py-2 text-sm font-medium uppercase text-white shadow-lg transition duration-150 ease-in-out hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400"
            >
              Start Your Journey
            </Link>
          </div>
